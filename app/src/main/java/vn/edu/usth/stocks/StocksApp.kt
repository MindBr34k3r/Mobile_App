...
import vn.edu.usth.stocks.ui.theme.Poppins
                    ...
                    when (currentDestination?.route) {
                        ...
                        Screen.StyleSettings.route ->
                            ...
                            IconButton(onClick = navigateTo(Screen.Settings.route)) {
                                Icon(
                                    painter = painterResource(id = Screen.Settings.icon ?: R.drawable.ic_show_chart_24),
                            ...
                            icon = {
                                Icon(
                                    painter = painterResource(
                                        id = screen.icon ?: R.drawable.ic_show_chart_24
                                    ),
